...
Scheme
{
	...
	// custom colors ----------------------------------------------------------------------------------------------------------	
		...
		"bwBlack"											"45 45 45 255"
		"bwBlackTrans"										"45 45 45 190"
	...
	BaseSettings
	{
		...
		Border.Bright						"blank"					//"TFTanLightDark"		// the lit side of a control
		Border.Dark							"blank"					//"TFTanLightDark"		// the dark/unlit side of a control
		Border.Selection					"blank"					//"BorderSelection"		// the additional border color for displaying the default/selected button
		...
		TextEntry.SelectedTextColor			"Gray30Solid"
		TextEntry.OutOfFocusSelectedBgColor"	"255 155 0 255"
		TextEntry.FocusEdgeColor			"accentM1"
	...
	// Borrowed from CS:S SourceScheme
		...
		FrameTitleBar.BgColor							"ListBG"
		FrameTitleBar.DisabledBgColor					"blank"
		
		GraphPanel.FgColor								"White"
		GraphPanel.BgColor								"ListBG"
