Scheme
{
	...
	BaseSettings
	{
		...
		Econ.Button.BgColor									"MaterialPrimary"
		Econ.Button.FgColor									"MaterialTextIcons"
		Econ.Button.ArmedBgColor							"MaterialAccent"
		Econ.Button.ArmedFgColor							"MaterialTextSecondary"
		Econ.Button.DepressedBgColor						"TFOrange"
		Econ.Button.DepressedFgColor						"Black"
		
		Econ.Button.PresetDefaultColorFg					"MaterialTextIcons"
		Econ.Button.PresetArmedColorFg						"MaterialTextIcons"
		Econ.Button.PresetDepressedColorFg					"MaterialTextIcons"
		
		Econ.Button.PresetDefaultColorBg					"MaterialAccent"
		Econ.Button.PresetArmedColorBg						"MaterialAccentDark"
		Econ.Button.PresetDepressedColorBg					"MaterialAccent"
		
		Border.Bright					"Blank"		// the lit side of a control
		Border.Dark						"Black"		// the dark/unlit side of a control
		Border.Selection				"Gray"			// the additional border color for displaying the default/selected button

		Button.TextColor				"MaterialTextIcons"
		Button.BgColor					"MaterialPrimary"
		Button.ArmedTextColor			"MaterialTextSecondary"
		Button.ArmedBgColor				"MaterialPrimaryDark"
		Button.SelectedTextColor		"MaterialTextSecondary"
		Button.SelectedBgColor			"MaterialAccentDark"
		Button.DepressedTextColor		"Black"
		Button.DepressedBgColor			"TFOrange"

		CheckButton.TextColor			"MaterialTextPrimary"
		CheckButton.SelectedTextColor	"MaterialTextIcon"
		CheckButton.BgColor				"MaterialDivider"
		CheckButton.Border1  			"MaterialTextIcon" 		// the left checkbutton border
		CheckButton.Border2  			"MaterialTextIcon"		// the right checkbutton border
		CheckButton.Check				"MaterialTextIcon"		// color of the check itself
		CheckButton.HighlightFgColor	"MaterialTextIcon"
		...
		Frame.FocusTransitionEffectTime	"0.1"	[$WIN32] // time it takes for a window to fade in/out on focus/out of focus
		...
		ListPanel.TextColor					"MaterialTextIcons"
		ListPanel.BgColor					"0 0 0 0"
		ListPanel.SelectedTextColor			"MaterialTextPrimary"
		ListPanel.SelectedBgColor			"MaterialDivider"
		ListPanel.SelectedOutOfFocusBgColor	"14 14 14 140"
		...
		ProgressBar.FgColor				"MaterialAccent"
		ProgressBar.BgColor				"MaterialTextIcons"

		CircularProgressBar.FgColor		"White"
		CircularProgressBar.BgColor		"White"
		
		"BuildingHealthBar.BgColor"		"MaterialTextPrimary"
		"BuildingHealthBar.Health"		"MaterialAccentDark"
		"BuildingHealthBar.LowHealth"	"MaterialLowHealth"
		...
		SectionedListPanel.HeaderTextColor	"MaterialDivider"
		SectionedListPanel.HeaderBgColor	"Blank"
		SectionedListPanel.DividerColor		"Black"
		SectionedListPanel.TextColor		"MaterialTextIcons"
		SectionedListPanel.BrightTextColor	"Orange"
		SectionedListPanel.BgColor			"0 0 0 0"
		SectionedListPanel.SelectedTextColor			"MaterialTextPrimary"
		SectionedListPanel.SelectedBgColor				"MaterialDivider"
		SectionedListPanel.OutOfFocusSelectedTextColor	"Black"
		SectionedListPanel.OutOfFocusSelectedBgColor	"14 14 14 140"
		...
		"ViewportBG"		"Blank"
		"TeamSpec"			"69 90 100 255"
		"TeamRed"			"211 47 47 255"
		"TeamBlue"			"25 118 210 255"
